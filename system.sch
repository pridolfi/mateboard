...
F 4 "7A-24.000MAAJ-T" V 1675 925 60  0001 C CNN "manf#"
	1    1675 925 
	0    -1   1    0   
$EndComp
Wire Wire Line
...
F 4 "GCM1555C1H180JA16D" V 1225 775 60  0001 C CNN "manf#"
	1    1225 775 
	0    1    -1   0   
$EndComp
Connection ~ 1675 775 
...
F 4 "SN74LVC1G07DCKR" H 7875 975 60  0001 C CNN "manf#"
	1    7875 975 
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 58AFE459
P 7925 1175
F 0 "#PWR0101" H 7925 925 50  0001 C CNN
...
U 1 1 58AFF28A
P 8950 1050
F 0 "#PWR0102" H 8950 900 50  0001 C CNN
...
U 1 1 58AFF2DD
P 8950 1700
F 0 "#PWR0103" H 8950 1450 50  0001 C CNN
...
F 4 "ABS07-32.768KHZ-7-T" V 1675 1425 60  0001 C CNN "manf#"
	1    1675 1425
	0    -1   1    0   
$EndComp
Wire Wire Line
...
F 2 "footprints:BeagleBone_Blue-GHI-IC_MICRON_EMMC_153_MODIFICADO" H 8275 3225 60  0001 C CNN
F 3 "" H 8275 3225 60  0001 C CNN
F 4 "SDIN8DE2-4G-I" H 8275 3225 60  0001 C CNN "manf#"
	1    8275 3225
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "08056D475KAT2A" H 10125 2450 60  0001 C CNN "manf#"
	1    10125 2450
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58D48CFA
P 10125 2600
F 0 "#PWR0112" H 10125 2350 50  0001 C CNN
...
U 1 1 58D48D02
P 9275 4175
F 0 "#PWR0105" H 9275 3925 50  0001 C CNN
...
F 4 "RC0402FR-0710KL" V 6600 2550 60  0001 C CNN "manf#"
	1    6600 2550
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58D48D66
P 7000 2275
F 0 "#PWR098" H 7000 2125 50  0001 C CNN
...
F 4 "SN74LVC1G06DCKR" H 6750 5075 60  0001 C CNN "manf#"
	1    6750 5075
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58D48DB0
P 6700 4700
F 0 "#PWR096" H 6700 4550 50  0001 C CNN
...
U 1 1 58D48DB6
P 6700 5275
F 0 "#PWR097" H 6700 5025 50  0001 C CNN
...
U 1 1 58D48DC3
P 7050 4800
F 0 "#PWR099" H 7050 4550 50  0001 C CNN
...
U 1 1 58D48DD0
P 9850 2275
F 0 "#FLG08" H 9850 2350 50  0001 C CNN
...
U 1 1 58DA59D5
P 7925 700
F 0 "#PWR0100" H 7925 550 50  0001 C CNN
...
F 4 "RC0402JR-070RL" V 5200 1175 60  0001 C CNN "manf#"
	1    5200 1175
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 4 "BLM15AG102SN1D" V 5725 1275 60  0001 C CNN "manf#"
	1    5725 1275
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 58DADD35
P 10650 2600
F 0 "#PWR0117" H 10650 2350 50  0001 C CNN
...
U 1 1 58DAEBBD
P 10100 3350
F 0 "#PWR0107" H 10100 3100 50  0001 C CNN
...
U 1 1 58DAEC64
P 10575 3350
F 0 "#PWR0114" H 10575 3100 50  0001 C CNN
...
U 1 1 58DB0D28
P 10575 3050
F 0 "#PWR0113" H 10575 2900 50  0001 C CNN
...
U 1 1 58DB0E3C
P 10100 4075
F 0 "#PWR0109" H 10100 3825 50  0001 C CNN
...
U 1 1 58DB0E42
P 10100 3775
F 0 "#PWR0108" H 10100 3625 50  0001 C CNN
...
U 1 1 58DB0EE7
P 10100 4775
F 0 "#PWR0111" H 10100 4525 50  0001 C CNN
...
U 1 1 58DB0EED
P 10100 4475
F 0 "#PWR0110" H 10100 4325 50  0001 C CNN
...
U 1 1 58DB11F2
P 10575 4075
F 0 "#PWR0116" H 10575 3825 50  0001 C CNN
...
U 1 1 58DB11F8
P 10575 3775
F 0 "#PWR0115" H 10575 3625 50  0001 C CNN
...
U 1 1 594B5AA6
P 3775 3075
AR Path="/594B5AA6" Ref="IC1"  Part="1" 
AR Path="/58AC1B74/594B5AA6" Ref="IC1"  Part="1" 
F 0 "IC1" H 3775 5529 45  0000 C CNN
F 1 "OSD335x" H 3775 5445 45  0000 C CNN
