...
$EndComp
$Comp
L VDD_1V8_WIFI #PWR0125
U 1 1 58AFB503
P 2950 3825
F 0 "#PWR0125" H 2950 3675 50  0001 C CNN
...
U 1 1 58AFB78D
P 2275 3875
F 0 "#PWR0126" H 2275 3625 50  0001 C CNN
...
Wire Wire Line
	2275 3875 2600 3875
$Comp
L VDD_3V3_WIFI #PWR0127
U 1 1 58AFB82E
P 4300 3825
F 0 "#PWR0127" H 4300 3675 50  0001 C CNN
...
U 1 1 58AFB993
P 5000 3875
F 0 "#PWR0128" H 5000 3625 50  0001 C CNN
...
U 1 1 58AFC8B4
P 4200 4825
F 0 "#PWR0129" H 4200 4575 50  0001 C CNN
...
U 1 1 58AFCDCF
P 2425 5175
F 0 "#PWR0130" H 2425 4925 50  0001 C CNN
...
$Comp
L VDD_1V8_WIFI #PWR0131
U 1 1 58AFD9D5
P 1100 3425
F 0 "#PWR0131" H 1100 3275 50  0001 C CNN
...
U 1 1 58B8B5E9
P 6925 3600
F 0 "#PWR0132" H 6925 3350 50  0001 C CNN
...
U 1 1 58B8F8A5
P 2950 5550
F 0 "#PWR0133" H 2950 5400 50  0001 C CNN
...
U 1 1 58B8F8B5
P 4300 5550
F 0 "#PWR0134" H 4300 5400 50  0001 C CNN
...
U 1 1 58B8F8F3
P 4200 6550
F 0 "#PWR0135" H 4200 6300 50  0001 C CNN
...
U 1 1 58B8FC58
P 2250 5600
F 0 "#PWR0136" H 2250 5350 50  0001 C CNN
...
U 1 1 58B946F0
P 2200 6900
F 0 "#PWR0139" H 2200 6650 50  0001 C CNN
...
U 1 1 58B96ABA
P 4600 6900
F 0 "#PWR0140" H 4600 6650 50  0001 C CNN
...
U 1 1 58B96AC6
P 4400 6900
F 0 "#PWR0141" H 4400 6650 50  0001 C CNN
...
U 1 1 58BB3E8E
P 7925 4000
F 0 "#PWR0143" H 7925 3750 50  0001 C CNN
...
U 1 1 58BB4A24
P 9475 3900
F 0 "#PWR0144" H 9475 3650 50  0001 C CNN
...
U 1 1 58BB6A01
P 7625 4700
F 0 "#PWR0145" H 7625 4450 50  0001 C CNN
...
U 1 1 58BB9360
P 10125 3600
F 0 "#PWR0147" H 10125 3350 50  0001 C CNN
...
$EndComp
$Comp
L VDD_1V8_WIFI #PWR0148
U 1 1 58BBCC74
P 4225 1200
F 0 "#PWR0148" H 4225 1050 50  0001 C CNN
...
U 1 1 58BBD93F
P 4925 1250
F 0 "#PWR0149" H 4925 1000 50  0001 C CNN
...
U 1 1 58BBEF7E
P 4225 2000
F 0 "#PWR0150" H 4225 1750 50  0001 C CNN
...
Wire Wire Line
	650  6050 1200 6050
$Comp
L VDD_1V8_WIFI #PWR0151
U 1 1 58BC3383
P 10850 2950
F 0 "#PWR0151" H 10850 2800 50  0001 C CNN
...
U 1 1 58BC8869
P 10750 3500
F 0 "#PWR0152" H 10750 3250 50  0001 C CNN
...
U 1 1 58BC8916
P 11000 3500
F 0 "#PWR0153" H 11000 3250 50  0001 C CNN
...
$EndComp
$Comp
L VDD_3V3_WIFI #PWR0154
U 1 1 58BCA01F
P 10850 1950
F 0 "#PWR0154" H 10850 1800 50  0001 C CNN
...
U 1 1 58BCAF5D
P 10750 2450
F 0 "#PWR0155" H 10750 2200 50  0001 C CNN
...
U 1 1 58BCB190
P 10975 2450
F 0 "#PWR0156" H 10975 2200 50  0001 C CNN
...
U 1 1 58BD1A26
P 7750 1400
F 0 "#PWR0157" H 7750 1150 50  0001 C CNN
...
U 1 1 58B8C8B1
P 1575 2150
F 0 "#PWR0158" H 1575 1900 50  0001 C CNN
...
U 1 1 58B8F17F
P 1575 1150
F 0 "#PWR0159" H 1575 1000 50  0001 C CNN
...
U 1 1 58B9014E
P 2750 2150
F 0 "#PWR0160" H 2750 1900 50  0001 C CNN
...
U 1 1 58B90160
P 2750 1150
F 0 "#PWR0161" H 2750 1000 50  0001 C CNN
